...
class SenPiBoxClient : public QObject
{
    Q_OBJECT
...
public:
    ...
    explicit SenPiBoxClient(QObject *parent = 0);
    ~SenPiBoxClient();
...
signals:
    void remoteCommandReceived(SenPiBoxClient::RemoteCommand remoteCommand);
    ...
    void commandFinished(SenPiBoxClient::Command command, QVariant data);
    void commandTimedOut(SenPiBoxClient::Command command);
    void queueFinished();
    void queueStarted();
...
Q_DECLARE_METATYPE(SenPiBoxClient::CommandHeader)
Q_DECLARE_METATYPE(SenPiBoxClient::RemoteCommand)
Q_DECLARE_METATYPE(SenPiBoxClient::StorageItem)
Q_DECLARE_METATYPE(SenPiBoxClient::WlanAuthType)
Q_DECLARE_METATYPE(SenPiBoxClient::IpDhcpMethod)
Q_DECLARE_METATYPE(SenPiBoxClient::Command)
Q_DECLARE_METATYPE(SenPiBoxClient::RemoteMedium)
