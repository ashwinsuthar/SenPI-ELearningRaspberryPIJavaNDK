#ifndef SENPICONTROLCLIENT_H
#define SENPICONTROLCLIENT_H
...
class SenPiControlClient : public QObject
{
    Q_OBJECT
...
public:
    ...
    explicit SenPiControlClient(QObject *parent = 0);
    virtual ~SenPiControlClient();
