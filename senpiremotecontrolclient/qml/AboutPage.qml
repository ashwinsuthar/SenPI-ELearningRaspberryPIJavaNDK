        ...
        Item {
            ...
            Flickable {
                ...
                Item {
                    ...
                    Text {
                        text: client.trialVersion?(qsTr("About SenPi") + client.emptyString):(qsTr("About SenPi") + client.emptyString)
style: Text.Raised
id: aboutText
                    ...
                    Text {
                        ...
                        text: qsTr("Copyright 2016 B.E Project<br>Project Guide:Prof. Vikas Singh.<br>Members:-Vinay Singh,Manish Yadav<br>& Ashwin Suthar.<br>Version:") + client.version + client.emptyString
                        color: theme.primaryColor
                        anchors {
                            left: logoImg.right
                            leftMargin: master.generalMargin*2
                ...
                Text {
                    ...
                    text: "<html><head><style>a:link{color:" + theme.highlightColor + "} a:visited{color:" + theme.highlightColor + "}</style></head> <body>" +
                          qsTr("If you find bugs and errors or want to give feedback please contact: <a href=\"mailto:support@senpi.org\">support@senpi.org</a><br>") +
                          qsTr("or visit <a href=\"http://senpi.org\">senpi.org</a> <br> <br>") +
                ...
                Button {
                        ...
                        text: qsTr("Visit SenPi website") + client.emptyString
                        icon: ""
                        onClicked: Qt.openUrlExternally("http://senpi.org/")
            ...
            Button {
                    ...
                    anchors.bottom: parent.bottom
                    anchors.margins: master.generalMargin
                    text: qsTr("Continue using SenPi") + client.emptyString
                    icon: ""
