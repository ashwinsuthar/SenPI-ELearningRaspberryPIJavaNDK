            ...
            Flickable {
                ...
                Text {
                    ...
                    text: "<html><head><style>a:link{color:" + theme.highlightColor + "} a:visited{color:" + theme.highlightColor + "}</style></head><body>" +
                          ...
                          qsTr("Make sure you have the server software installed on the computer which you want to remote control. You can download the software at: <a href=\"http://senpi.org/download.php#Download\">senpi.org</a> <br> <br>") +
                          ...
                          qsTr("- Click \"Search Servers\" on your smart phone to discover the servers on your network.<br>") +
