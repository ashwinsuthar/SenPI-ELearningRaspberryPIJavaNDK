            ...
            Flickable {
                ...
                Text {
                    ...
                    text: "<html><head><style>a:link{color:" + theme.highlightColor + "} a:visited{color:" + theme.highlightColor + "}</style></head><body>" +
                          qsTr("If you like this application please support us and share it with your friends.") +
                ...
                Button {
                        ...
                        icon: ""
                        onClicked: Qt.openUrlExternally("https://www.facebook.com/SenPi")
                ...
                Button {
                        ...
                        icon: ""
                        onClicked: Qt.openUrlExternally("https://twitter.com/senpi")
                        Image {
                            id: twitterIcon
                            width: height
                ...
                Button {
                        ...
                        icon: ""
                        onClicked: Qt.openUrlExternally("https://plus.google.com/senpi/posts")
                ...
                Button {
                        ...
                        icon: ""
                        onClicked: Qt.openUrlExternally("https://flattr.com/profile/senpi")
                ...
                Button {
                        ...
                        icon: ""
                        onClicked: Qt.openUrlExternally("https://www.paypal.com/cgi-bin/webscr?cmd=senpi")
                ...
                Button {
                        ...
                        icon: ""
                        onClicked: Qt.openUrlExternally("bitcoin:senpi")
